...
import static QRDiscount.JWT.SecurityConstants.EXPIRATION_TIME;
import static QRDiscount.JWT.SecurityConstants.SECRET;
import QRDiscount.Repositories.UserRepository;
import QRDiscount.Security.UserDetailsImpl;
...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        AppUser user = userRepository.findByEmailOrUsername(userPrincipal.getUsername(), userPrincipal.getUsername());
        return Jwts.builder()
